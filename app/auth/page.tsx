      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {panel === 'login' && (
          <div className={`auth-card p-8 md:p-10 ${anim}`}>
            ...
            <div className="space-y-3 mb-6">
              <button className="social-btn" onClick={handleGoogleSignIn}><GoogleIcon /> Continue with Google</button>
            </div>
        ...
        {panel === 'signup' && (
          <div className={`auth-card p-8 md:p-10 ${anim}`}>
            ...
            <div className="space-y-3 mb-6">
              <button className="social-btn" onClick={handleGoogleSignIn}><GoogleIcon /> Sign up with Google</button>
            </div>
